...
export function getFretOffset(number, neckLength, fretCount = 24) {
    if (number === 0) {
        return SIDE_MARGIN;
    } else if (number < 0) {
        return -10;
        ...
        if (fretCount === 24) {
            ...
            const newNeckLength = (neckLength - SIDE_MARGIN) / getFretOffset(fretCount, neckLength) * neckLength;
...
export function Fret({ number, fretCount, neckLength, neckWidth }) {
